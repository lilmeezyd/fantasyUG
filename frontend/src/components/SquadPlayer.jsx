...
const SquadPlayer = (props) => {
  ...
  return (
    <>
      ...
      {baller?._id && <TransferPopUp elementTypes={elementTypes} removePlayer={removePlayer} players={players} handleClose={handleClose} show={show} baller={baller}></TransferPopUp>}
    </>
  );
};
    ...
    <Modal show={show} onHide={handleClose}>
        <Modal.Header style={{ background: "aquamarine" }} closeButton>
         ...
         <div className="namesection">
          <span>{playerDetails?.firstName}&nbsp;{playerDetails?.secondName}</span>
      </div>
          </Modal.Title>
        </Modal.Header>
      ...
      <div className="infobuttons">
        <button
           onClick={transferOut} className='btn-success form-control'>Remove Player</button>
      </div>
        </Modal.Body>
      </Modal>
